...
def update_secrets_in_file(openai_api_key=None, google_api_key=None, google_cse_id=None):
...
def set_keys():
    ...
    if request.method == 'POST':
        ...
        update_secrets_in_file(openai_api_key=new_openai_api_key,
...
def upload_resume():
    ...
    if 'file' in request.files:
        ...
        if allowed_file(resume_file.filename):
            _, file_extension = os.path.splitext(resume_file.filename)  # Get file extension
...
def upload_cover_letter():
    ...
    if 'file' in request.files:
        ...
        if allowed_file(cover_letter_file.filename):
            _, file_extension = os.path.splitext(cover_letter_file.filename)  # Get file extension
...
def upload_other():
    ...
    if 'file' in request.files:
        ...
        if allowed_file(other_file.filename):
            _, file_extension = os.path.splitext(other_file.filename)  # Get file extension
